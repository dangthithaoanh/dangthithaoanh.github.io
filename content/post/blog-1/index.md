---
title: '#### LET-REMA-LCEX19 Introduction to Language and Speech Technology Take-home
  exam'
date: '2023-12-27'
---
...
Welcome to the take-home exam of the first part of the course. The theme of this exam is **from words to numbers**: representing elements of written human language as numbers is a critical step in any language technology pipeline. But the challenges and limitations of making human language "computer-readable" are plenty. How are words represented in computers? What about other levels of representation, large and small? From letters, to grammatical relations, and long-range dependencies, each aspect of meaning needs to be 'formalized' and turned into numbers in order to make NLP pipelines work. From the very basics to complex ML applications, how do Natural Language Processing (NLP) pipelines typically deal with these problem? What practices and solutions has the field come up with? How is written human language represented for specific NLP applications, e.g. text classification or language modeling? What assumptions are build into such technolgy?     

####  Instructions

This is an **individual** take-home exam. Please complete the exam on your own and write entirely in your own words.

Write the exam in form of an Python notebook (.ipynb). The easiest way to get started is to make a copy of this very document here and start working below. The exam should contain both text cells (written in full sentences) and code cells (with pseudocode) to illustrate relevant concepts. No minimum number of code cells is specified - include as many code cells in your document as you see fit.
...
Your submission should be between 7000 and 10000 words (including this text of 650 words, and including your pseudocode). Diverging significantly from this range will impact the grade (20% more or less). That means the minimum workcount of what you have to add to this document is around 5000.   

The easiest way to check the length of your document is to download the file as Python code (.py) and open that file in Microsoft Word to count the words.
...
Your name: Dang Thi Thao Anh

Student number: s1097513
